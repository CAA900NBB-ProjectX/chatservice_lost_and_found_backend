...
@NamedQuery(name = MessageConstants.FIND_LAST_MESSAGE_BY_CHAT_ID_SENDER,
        query = "SELECT m FROM Message m WHERE m.chat.id = :chatId ORDER BY m.createdDate DESC LIMIT 1"
)
